...
Perform the following calculations from Essentials of Digital Signal Processing by BP Lathi & Roger A. Green and provide satisfactory simulation results.

3.  Book problem 2.1-5(d).

4.  Book problem 2.2-2.

5.  Book problem 2.3-3.

6.  Book problem 2.4-3.

7.  Book problem 2.5-1.

8.  Book problem 2.6-1(b,c).

9. Book problem 2.6-3(a,c,d).
